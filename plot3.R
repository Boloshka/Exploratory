...
png(filename = "/home/leon/New path/Data_science/Exploratory Data/plot3.png", width = 480, height = 480,units = "px")
...
legend(x = New_date[2000],y = 40, c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),lwd = c(2,2,2),col=c("black","red","blue"))
